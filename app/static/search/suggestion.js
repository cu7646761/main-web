        ...
        $('#user_input').autocomplete(
            {
                ...
                delay: 50,
                open: function () {
                    $('.ui-autocomplete').css('width', '50rem'); // HERE
...
$('#user_input_store_admin').on('input', function (e) {

    var user_input = $('#user_input_store_admin').val();
    ...
    $.ajax(settings).done(function (response) {
        ...
        $('#user_input_store_admin').autocomplete(
            {
                source: titles,
                delay: 50,
                open: function () {
...
$('#user_input_user_admin').on('input', function (e) {

    var user_input = $('#user_input_user_admin').val();
    ...
    $.ajax(settings).done(function (response) {
        ...
        titles = [];
        for (var i = 0; i < data.length; i++) {
            field_name = data[i]["_source"]["name"] || data[i]["_source"]["email"];
            titles.push(field_name);
        }
        console.log(titles);


        $('#user_input_user_admin').autocomplete(
            {
                source: titles,
                delay: 50,
                open: function () {
